...
do_read()
{
    ...
    // TODO uncomment parser_->body_limit(10000); 
...
{
    std::cout << "http_session::on_read called" << std::endl;
    ...
    {
        std::cout << "websocket::is_upgrade called" << std::endl;
    ...
    std::cout << "websocket is not upgraded" << std::endl;
/*
    // Handle request
